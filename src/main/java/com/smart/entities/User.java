...
public class User {
	...
	@Size(min = 3, max = 13, message = "size must be between 3 and 13")
	private String name;
	...
	@NotBlank(message = "Give a valid password")
	...
	@Column(length = 500)
	@NotBlank(message = "Please write something here!!")
	@Size(min = 10 , max = 500, message = "enter minimum 10 characters")
